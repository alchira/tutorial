...
> The append class loader is a special variant of the scattered class loader that uses the & operator. Instead of only applying classes, it also appends the associated staple snippet to the end of the tag, making it especially useful for importing symbols. Which will be explained in [dependacy](./5.0-depedancy.md) in detail.
